...
genes4radar = c("CD4", "CD3D",  "CD28", "TBX21", "GATA3", "IRF4", "CCR4",
          "RORC", "FOXP3", "FOXP1", "IL9", "IL10", "IL13", "IL17A", "PDCD1", "GZMK", "TGFB1",
          "SELL", "TCF7", )
...
sample_id_1 = "X_112_BL"
sample_id_2 = "X_112_9M"
...
write.csv(shared_clones_table, 
          file = "Results/CD4_Tcell_shared_clones_table_X_112.csv", 
          row.names = FALSE)
...
ggplot(biased, aes(x=ncells, y=bias)) +
  ...
  ylab("Clonal Bias")
fig_name = paste0(plot_dir, method, "clonotype_bias_sample_", sample_id, "_v2.png")
ggsave(fig_name, height=fig.height, width=fig.width, dpi = 300)
